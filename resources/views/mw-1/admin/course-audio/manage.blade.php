    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="card-title fw-semibold">Courses audio</h5>
                <div>
                    <a href="{{ url('/manage-admin/add-audio') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
                    ...
                    <!-- <tbody>
                        ...
                        @foreach ($getAudio as $data)
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <a href="{{ url('/manage-admin/edit-audio', ['id' => $data->id]) }}"
                                        class="btn btn-success btn-sm btn-icon-text mr-3">
                                        Edit
                                        <i class="typcn typcn-edit btn-icon-append"></i>
                                    </a>
                                    <a href="{{ url('/manage-admin/delete-audio', ['id' => $data->id]) }}"
...
@section('js')
    @include('mw-1.admin.course-audio.datatable')
@endsection
