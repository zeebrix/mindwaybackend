                    ...
                    <tbody>
                        ...
                        @foreach ($viewSleepCourse as $data)
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <p class="mb-0 fw-normal">{{ $data->category_id }}</p>
                                </td>
                                ...
                                <td class="border-bottom-0">
                                    <img height="50px" width="50px" class="popup"
                                        src="{{ asset('storage/course') }}/{{ $data->thumbnail }}" alt="">
                                </td>
                                ...
                                <td class="border-bottom-0">
                                    <a href="{{ url('/manage-admin/edit-sleep-course', ['id' => $data->id]) }}"
                                        class="btn btn-success btn-sm btn-icon-text mr-3">
                                        Edit
                                        <i class="typcn typcn-edit btn-icon-append"></i>
                                    </a>
                                    <a href="{{ url('/manage-admin/delete-sleep-course', ['id' => $data->id]) }}"
