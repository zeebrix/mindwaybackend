    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="card-title fw-semibold">Sleep Screen</h5>
                <div>
                    <a href="{{ url('/manage-admin/add-sleep-screen') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
                ...
                <table class="table text-nowrap mb-0 align-middle">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">Sleep audio</h6>
                            </th>
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">Sleep Image</h6>
                            </th>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <audio controls="" style="vertical-align: middle"
                                        src="{{ asset('storage/') }}/{{ $data->sleep_audio }}" type="audio/mp3"
                                ...
                                <td class="border-bottom-0">
                                    <img height="50px" width="50px" class="popup"
                                        src="{{ asset('storage/SleepScreen') }}/{{ $data->image }}" alt="no image">
                                </td>
                                ...
                                <td class="border-bottom-0">
                                  ...
                                  <i class="typcn typcn-edit btn-icon-append"></i>
                                    ...
                                    <a href="{{ url('/manage-admin/delete-sleep-screen', ['id' => $data->id]) }}"
