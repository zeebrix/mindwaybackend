    ...
    <div class="card w-100">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h5 class="card-title fw-semibold">Home Screen</h5>
                <div>
                    <a href="{{ url('/manage-admin/add-home') }}" class="btn btn-primary">Add New</a>
                </div>
            </div>
                ...
                <table class="table text-nowrap mb-0 align-middle" id="Yajra-dataTable">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th class="border-bottom-0">
                                <h6 class="fw-semibold mb-0">Home audio</h6>
                            </th>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <img height="50px" width="50px" class="popup"
                                        src="{{ asset('storage/homescreen') }}/{{ $data->image }}" alt="">
                                </td>

                                <td class="border-bottom-0">
                                    <audio controls="" style="vertical-align: middle"
                                        src="{{ asset('storage/') }}/{{ $data->home_audio }}" type="audio/mp3"
                                ...
                                <td class="border-bottom-0">
                               <a href="{{ url('/manage-admin/edit-home',['id' => $data->id]) }}" class="btn btn-success btn-sm btn-icon-text mr-3">
                                  Edit
                                  <i class="typcn typcn-edit btn-icon-append"></i>
                                </a>
                                <a href="{{ url('/manage-admin/delete-home',['id' => $data->id]) }}"  class="btn btn-danger btn-sm btn-icon-text">
                                  Delete
...
@endsection
@section('js')
    @include('mw-1.admin.home-screen.datatable')
@endsection
