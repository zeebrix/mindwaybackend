...
<div class="row">
    <div class="col-10 offset-1">
        ...
        <br>
        <form action="{{ route('manage-admin.profileSave') }}" id="profile_form" method="POST" enctype="multipart/form-data">
            @csrf

            <input type="hidden" value="{{ $id }}" name="counsellorId" id="counsellorId">
            <div class="row">
                ...
                <div class="col-12 me-3">
                    <div class="card" style="border-radius: 20px">
                        <div style="height: 150" class="card-body d-flex flex-column justify-content-center p-4">
                            ...
                            <p class="mb-1">Link Mindway Calendar to prevent double booking</p>
            ...
            function selectTimezone(timezoneId, timezoneDisplay) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // console.log('Time zone saved successfully:', response);
...
<script>
    ...
    document.getElementById('uploadLogoInput').addEventListener('change', function() {
        ...
        var counsellorId = document.getElementById('counsellorId').value;
