                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <img height="50px" width="50px" class="popup"
                                        src="{{ asset('storage/music') }}/{{ $data->image }}" alt="">
                                </td>

                                <td class="border-bottom-0">
                                    <audio controls="" style="vertical-align: middle"
                                        src="{{ asset('storage/') }}/{{ $data->music_audio }}" type="audio/mp3"
                                ...
                                <td class="border-bottom-0">
                                    <a href="{{ url('/manage-admin/edit-music', ['id' => $data->id]) }}"
                                        class="btn btn-success btn-sm btn-icon-text mr-3">
                                        Edit
                                        <i class="typcn typcn-edit btn-icon-append"></i>
                                    </a>
                                    <a href="{{ url('/manage-admin/delete-music', ['id' => $data->id]) }}"
