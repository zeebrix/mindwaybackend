    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('approve.session') }}" method="POST" class="mb-3">
                    @csrf
                ...
                <!-- Deny Sessions Form -->
                <form action="{{ route('deny.session') }}" method="POST">
                    @csrf
                    <input type="hidden" name="requestedId" id="requestedIdDeny">
                    <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" class="btn w-100" style="background-color: transparent; border: 1px solid #000; color: #000;">Deny Sessions</button>
                    </div>
                    </div>
                </form>
            </div>
