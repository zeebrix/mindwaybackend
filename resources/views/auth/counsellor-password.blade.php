...
<body>
  <div class="login-container">
    ...
    margin-top: 6px;">Hi {{ request('name') }} 👋</h2>


      <form class="pt-3" method="POST" action="{{url('counsellor/set-password') }}">
        @csrf
        <input type="hidden" name="counsellorId" value="{{request('token')}}">
        <input type="hidden" name="email" value="{{request('email')}}">
        <div class="form-group">
          <label class="form-label" style="font-weight: 600;">Set Password</label>
