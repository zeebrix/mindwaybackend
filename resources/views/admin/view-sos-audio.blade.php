                ...
                <div class="table-responsive pt-3">
                  <table class="table table-striped project-orders-table">
                    ...
                    <tbody>
                      ...
                      <td>  <audio controls="" style="vertical-align: middle" src="{{ asset('storage/') }}/{{ $data->sos_audio }}" type="audio/mp3" controlslist="nodownload">
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <a href="{{ url('/manage-admin/delete-sos-audio',['id' => $data->id]) }}"  class="btn btn-danger btn-sm btn-icon-text">
                                  Delete
