...
<body>
  <div class="login-container">
    ...
    <div class="login-form">
      <img src="{{ asset('/logo/logo.png') }}" width="147px" height="29px" alt="Mindway Logo">
      <h2 style="margin-left: 20px;margin-top: 6px;">Log in to Admin Portal</h2>
      ...
      <div class="helper-links">
        <a href="{{route('password.request','admin')}}" style="color:#8A8A8E;">Forgot password?</a><br>
        <!-- <span style="color:#8A8A8E;">Don’t have an account? </span><a href="#">Sign Up</a> -->
      </div>
    </div>
  </div>
  <!-- container-scroller -->
