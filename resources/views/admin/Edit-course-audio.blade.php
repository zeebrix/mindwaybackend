                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <h2>Edit course audio</h2>

                            <form action="{{ url('/manage-admin/update-audio') }}" method="POST"
                                ...
                                <select name="session_id">
                                    ...
                                    @foreach ($sessionList as $session1)
                                        <option name="session_id" value="{{ $session1->id }}">{{ $session1->id }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                @foreach ($getAudio as $session)
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $session->duration }}"
                                            placeholder="Enter audio duration" name="duration" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="">Audio title:</label>
                                        <input type="text" class="form-control" value="{{ $session->audio_title }}"
